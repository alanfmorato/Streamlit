...
## Gráficos
fig_mapa_receita = px.bar(receita_estado.head(), 
                                  x = 'Local da compra',
                                  y = 'Preço',
                                  text_auto=True,
...
fig_mapa_categoria = px.bar(receita_categoria.head(),
                            text_auto=True,
...
with aba1:
    ...
    with coluna1:
        ...
        st.plotly_chart(fig_mapa_categoria, use_container_width= True)
